function animateMoves() {
  ...
  function step() {
    ...
    try {
      ...
      // Force style/layout flush, then start animation on the following frame.
      // Without this, some browsers batch initial+final transform writes and skip interpolation.
      movingAnimations.forEach(({ clone }) => clone.getBoundingClientRect());
